<x-admin-app>
    <section class="w-full">
        ...
        <div class="pb-3">
            <a href="{{ route('treatment.create') }}" class="px-3 py-1 border rounded shadow-xl">Tambah Data</a>
        </div>
            ...
            <table class="w-full ">
                <thead>
                    <tr>
                        ...
                        <th class="px-3 py-1 text-sm w-auto font-semibold bg-slate-400">Deskripsi</th>
                        <th class="px-3 py-1 text-sm w-auto font-semibold bg-slate-400">Harga</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-slate-100">
                        ...
                        <td class="text-sm flex gap-3 p-3 border">
                            <a href="{{ route('treatment.show', $data) }}" class="bg-yellow-500 px-3 py-2">Lihat Data</a>
                            <form action="{{ route('treatment.destroy', $data) }}" method="POST">
                                @csrf
                                @method('DELETE')
